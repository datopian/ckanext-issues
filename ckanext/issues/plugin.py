...
from ckanext.issues.logic.action import action
...
class IssuesPlugin(p.SingletonPlugin, DefaultTranslation):
    ...
    def get_helpers(self):
        ...
        return {
            ...
            "issues_enabled_for_organization": helpers.issues_enabled_for_organization,
    ...
    def get_actions(self):
        return {
            ...
            "issue_comment_update": action.issue_comment_update,
    ...
    def get_auth_functions(self):
        ...
        return {
            ...
            "issue_comment_update": auth.issue_comment_update,
