...
issues.add_url_rule('/dataset/<dataset_id>/discussion', view_func=dataset, methods=['GET'])

# New issue
issues.add_url_rule('/dataset/<dataset_id>/discussion/new', view_func=new, methods=['GET', 'POST'])

# Shows an issue
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>', view_func=show_issue, methods=['GET'])

# Add issue with resources
issues.add_url_rule('/dataset/<dataset_id>/discussion/new/<resource_id>', view_func=new, methods=['GET', 'POST'])

# Edit an issue
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>/edit', view_func=edit, methods=['GET', 'POST'])

# Delete an issue
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>/delete', view_func=delete, methods=['GET', 'POST'])

# Assign an issue
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>/assign', view_func=assign, methods=['POST'])

# Comment on an issue
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>/comments', view_func=comments, methods=['POST'])

# Report an issue
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>/report', view_func=report, methods=['GET', 'POST'])

# Clear issue report
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>/report_clear', view_func=report_clear, methods=['GET', 'POST'])

# Report comment
issues.add_url_rule('/dataset/<dataset_id>/discussion/<int:issue_number>/comment/<comment_id>/report', view_func=report_comment, methods=['GET', 'POST'])
...
issues.add_url_rule('/organization/<org_id>/discussion', view_func=issues_for_organization, methods=['GET'])
